...
#'  \item \bold{Homepage}: \url{http://www.vincentbonhomme.fr/Momocs}
#'  \item \bold{GitHub repo}: \url{https://github.com/vbonhomme/Momocs}
#'  to contribute to dev, report a bug, ask for something, etc.
#' }
#'
#' @references
#' \itemize{
