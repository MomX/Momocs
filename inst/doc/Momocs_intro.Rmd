...
### News
Momocs is being extensively polished these days and may evolve before its 2.0 release as prt of [MomX](http://momx.online).
 -- October 2018
...
First, of all, let's download the last version of Momocs. You will need to install the `devtools` package to get it from my [GitHub](http://www.github.com/MomX/Momocs) repository :
