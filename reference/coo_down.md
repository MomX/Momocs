...
[Coo](http://momx.github.io/Momocs/reference/Coo.md) object
([Out](http://momx.github.io/Momocs/reference/Out.md) are returned as
[Opn](http://momx.github.io/Momocs/reference/Opn.md))

## Note

When shapes are "sliced" along the x-axis, it usually results on open
curves and thus to huge/artefactual gaps between points neighboring this
axis. This is usually solved with
[coo_slidegap](http://momx.github.io/Momocs/reference/coo_slidegap.md).
See examples there.

Also, when apply a coo_left/right/up/down on an
[Out](http://momx.github.io/Momocs/reference/Out.md) object, you then
obtain an [Opn](http://momx.github.io/Momocs/reference/Opn.md) object,
