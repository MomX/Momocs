...
- coo:
  ...
  either a `matrix` of (x; y) coordinates or a
...
It probably only make sense for Coo objects with the same number of
coordinates and them being homologous, typically on Ldk.
