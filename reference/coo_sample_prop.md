...
As for
[coo_sample](http://momx.github.io/Momocs/reference/coo_sample.md) if an
`$ldk` component is defined, it is changed accordingly by multiplying
the ids by n over the number of coordinates.
