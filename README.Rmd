...
[![Travis-CI Build Status](https://travis-ci.org/MomX/Momocs.svg?branch=master)](https://travis-ci.org/vbonhomme/Momocs)
[![Coverage Status](https://img.shields.io/codecov/c/MomX/vbonhomme/Momocs/master.svg)](https://codecov.io/github/MomX/Momocs?branch=master)
...
__:love_letter::love_letter::love_letter: Momocs is in a phase of very active development (see [#184](https://github.com/vbonhomme/MomX/issues/184)).__
