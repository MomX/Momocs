...
Here we start to see shapes and that's pretty much what the `stack` function does. This behaviour is possible since all `cheapbabi` functions propagate the object they use(d):
